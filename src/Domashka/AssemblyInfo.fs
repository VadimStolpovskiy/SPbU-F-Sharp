...
[<assembly: AssemblyTitleAttribute("Domashka")>]
[<assembly: AssemblyProductAttribute("Domashka")>]
...
module internal AssemblyVersionInformation =
    let [<Literal>] AssemblyTitle = "Domashka"
    let [<Literal>] AssemblyProduct = "Domashka"
